...
/**
 * The Interface RoleMemberRepository.
 *
 * @author pabhishek
 */
public interface RoleMemberRepository extends JpaRepository< Role, String > {
     ...
     * @return the map
     */
    @Query("select role from GR_ROLE role")
    public List<Role> findRoleIdAndRoleNameMap();
