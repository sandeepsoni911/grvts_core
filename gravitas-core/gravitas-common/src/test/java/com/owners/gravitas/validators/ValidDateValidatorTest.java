...
/**
 * The Class ValidDateValidatorTest.
 *
 * @author pabhishek
 */
public class ValidDateValidatorTest extends AbstractBaseMockitoTest {

	/** The constraint validator. */
    @InjectMocks
    private ValidDateValidator constraintValidator;
    ...
    public void testInitialize() {
        constraintValidator.initialize( new ValidDate() {
