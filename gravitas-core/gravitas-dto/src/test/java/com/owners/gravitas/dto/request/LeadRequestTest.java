...
/**
 * Test class for {@link LeadRequest}.
 *
 * @author harshads
 *
 */
public class LeadRequestTest {
    ...
    private void createLeadRequestTestValues() {
        ...
        leadRequestTestValues.put( "leadType", "test" );
        ...
        leadRequestTestValues.put( "loanNumber", 10 );
...
//    @Test
    public final void testLeadRequest() {
        final BeanLikeTester blt = new BeanLikeTester( GenericLeadRequest.class );
